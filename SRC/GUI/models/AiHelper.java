...
public class AiHelper {
    ...
    /**
     * Check if the AI player has a Wild Console.Model.Card in their current hand
     *
     * @param playerHand the current hand of the AI player
     * @return whether the current hand of the AI player contains a Wild Console.Model.Card
     */
